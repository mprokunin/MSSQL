...
/****** Object:  Job [ADM.io_stalls]    Script Date: 10/24/2020 9:14:17 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Notifies]]    Script Date: 10/24/2020 9:14:17 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [io_stalls]    Script Date: 10/24/2020 9:14:17 AM ******/
...
declare 	@MailProfile sysname =  ''DBMailProfile''
	, @Recip varchar(max) = ''SQLAdmin@renins.com'' 
