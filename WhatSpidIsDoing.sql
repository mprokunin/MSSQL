...
select 'kill ' + convert(varchar(10), spid) from sys.sysprocesses where loginame like  '%ICATON\ServiceBroker_Rabbit%'
...
dbcc inputbuffer(69) --    EXECUTE [dbo].[IndexOptimize]  @Databases = 'AtonBase',  @TimeLimit=100500,  @LogToTable = 'Y'
...
exec AtonBase_CDS..sp_help 'RISKWATCH.GetCounterpartyLimitData'
...
ORDER BY
 ...
 --exec spALMainTradingCreditGetXML @pBegDate='20180101',@pEndDate='20181219',@FilePath='\\svuapp401.atoneu.global\1C_Unload\ATM\P_AST\tmp1\TradingCredit_20180101_20181219.xml',@Version='1'
