...
------------------------
-- Backup distribution DB and put in to AG group REPHADR
--BackupRestoreDuistributuin.sql
--ADD_DB_DISTRIBUTION.sql
...
use [TDB]
exec sp_addarticle 
	@publication = N'TDB_Pub', @article = N'Table_1', @source_owner = N'dbo', 
	@source_object = N'Table_1', 
	@type = N'logbased', @description = N'', @creation_script = null, @pre_creation_cmd = N'drop', 
	@schema_option = 0x000000000803509F, @identityrangemanagementoption = N'manual', 
	@destination_table = N'Table_1', @destination_owner = N'dbo', 
	@vertical_partition = N'true', @ins_cmd = N'CALL sp_MSins_dboTable_1', 
	@del_cmd = N'CALL sp_MSdel_dboTable_1', @upd_cmd = N'SCALL sp_MSupd_dboTable_1'
-- Commands completed successfully.
...
use [TDB]
--exec sp_dropsubscription @publication = N'TDB_Pub', @subscriber = N'BROWN', @destination_db = N'TDB', @article = N'all'
GO
exec sp_addsubscription @publication = N'TDB_Pub', @subscriber = N'brown', @destination_db = N'TDB', 
...
exec sp_addpullsubscription_agent @publisher = N'TSQL03\SQL2008', @publisher_db = N'TDB', @publication = N'TDB_Pub', @distributor = N'REPHADR', @distributor_security_mode = 1, @distributor_login = N'', @distributor_password = null, @enabled_for_syncmgr = N'False', @frequency_type = 64, @frequency_interval = 0, @frequency_relative_interval = 0, @frequency_recurrence_factor = 0, @frequency_subday = 0, @frequency_subday_interval = 0, @active_start_time_of_day = 0, @active_end_time_of_day = 235959, @active_start_date = 20190508, @active_end_date = 99991231, @alt_snapshot_folder = N'', @working_directory = N'', @use_ftp = N'False', @job_login = null, @job_password = null, @publication_type = 0
