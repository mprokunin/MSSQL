...
MODIFY REPLICA ON N'SQL202\WEB' WITH (SECONDARY_ROLE(READ_ONLY_ROUTING_URL = N'TCP://SQL202.corp.global:52711'))
GO

ALTER AVAILABILITY GROUP [Webhadr1]
MODIFY REPLICA ON N'AL-SQL04\WEB' WITH (SECONDARY_ROLE(READ_ONLY_ROUTING_URL = N'TCP://AL-SQL04.corp.global:51804'))
GO
