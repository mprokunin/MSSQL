...
/****** Object:  StoredProcedure [dbo].[ReindexOffline]    Script Date: 03.10.2018 11:33:07 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[ReindexOffline]   
AS   
    SET NOCOUNT ON;  
	...
	BEGIN
			...
			SET @Rebuild = 'ALTER INDEX [' + @IndexName + '] ON [' + @SchemaName + '].[' + @TableName + '] REBUILD WITH (ONLINE = OFF)';
