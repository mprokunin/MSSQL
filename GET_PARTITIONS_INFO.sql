...
sp_spaceused [policies]

--name	    rows	reserved	data	index_size	unused
--policies	30062   27817768 KB	27509312 KB	76984 KB	231472 KB

ALTER TABLE [policies]
REBUILD PARTITION = 5 WITH (DATA_COMPRESSION =  NONE)  
...
select * from [dbo].[PartitionRanges]
sp_helpdb [nfo20_report]
exec xp_fixeddrives

USE [DI_STAT]
GO

/****** Object:  PartitionScheme [Scheme_Func_B2B_INSURANCE_OBJECT_PARTIONED]    Script Date: 12/19/2019 7:02:58 PM ******/
CREATE PARTITION SCHEME [Scheme_Func_B2B_INSURANCE_OBJECT_PARTIONED] AS PARTITION [Func_B2B_INSURANCE_OBJECT_PARTIONED] TO ([B2B_INSURANCE_OBJECT_PARTIONED_2009], [B2B_INSURANCE_OBJECT_PARTIONED_2010], [B2B_INSURANCE_OBJECT_PARTIONED_2011], [B2B_INSURANCE_OBJECT_PARTIONED_2012], [B2B_INSURANCE_OBJECT_PARTIONED_2013], [B2B_INSURANCE_OBJECT_PARTIONED_2014], [B2B_INSURANCE_OBJECT_PARTIONED_2015], [B2B_INSURANCE_OBJECT_PARTIONED_2016], [B2B_INSURANCE_OBJECT_PARTIONED_2017], [B2B_INSURANCE_OBJECT_PARTIONED_2018], [PRIMARY], [B2B_INSURANCE_OBJECT_PARTIONED_2019])
GO
