DECLARE @Name varchar(30) = 'CRM_to_WEB_over_sql'
...
*/
    ...
    WHERE
		...
		AND princ.[name] LIKE CASE WHEN @Name = '' then '%' ELSE '%' + @Name + '%' END 
...
UNION
    ...
    WHERE
		...
		AND roleprinc.[name] LIKE CASE WHEN @Name = '' then '%' ELSE '%' + @Name + '%' END 
