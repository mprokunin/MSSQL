...
Declare @version varchar(40) = 'v1.2 2019-04-22 without DeployLogin',
	@MaxID int,
	@CurrID int,
	@SQL nvarchar(max),
	@LoginName sysname,
...
Set @SQL = 'Select P.name, P.sid, P.is_disabled, L.is_policy_checked, P.type,  CAST(  L.password_hash  AS varbinary (256) )' + CHAR(10) +
		...
		'And P.name <> ''DeployLogin''' + CHAR(10) +
...
--exec mirror_logins_copy 'AL-SQL03\AOLFRONT', 1
--select @@SERVERNAME

sp_helplogins [ICATON\Shabalin]