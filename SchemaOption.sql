...
--https://repltalk.com/2010/02/24/decrypting-schema_option-parameters-binary-value-for-a-transactional-replication-article/
...
SET @schemaoption  = 0x0000000008035097     --Replace the value here
---------------
SET NOCOUNT ON
